...
public class GetCustomObjectByIdRequest extends BaseRequest {

	/**
	 * FileNet custom object id like {107DE07F-0000-C315-97F6-28C25358CD22}
	 * 
	 * @param customObjectId the new custom object id
